...
module.exports = function () {
	...
	// Direct url link to a specific categoria
	_helpers.categoriaUrl = function (categoriaSlug, options) {
	...
	_helpers.tipoCatUrl = function (categoriaSlug, tipo) {
		return ('/products/' + categoriaSlug + '/' + tipo );
	};

// url link download file
	_helpers.fileUrl = function (name) {
